...
import sgbd.forms.dialogs.ConnectionParamsDialog;
...
public class ConnectionPanel extends javax.swing.JPanel {
    ...
    public void showParamsDialog() {
        ...
        ActionListener btnActionListener = (ActionEvent e) -> {
            if(e.getSource() == panel.getButton("confirm")) {
                json.setParam("Host", panel.getInput("Host"));
                json.setParam("Port", panel.getInput("Port"));
                json.setParam("Database", panel.getInput("Database"));
                json.setParam("SGBD", panel.getInput("SGBD"));
                json.save();
            }
            dialog.dispose();
        };
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
       controller = new Controller(json.getSGBD(), json.getParams());
